...
<body>
	<form method="post" action="regProc.jsp" name="regForm">
		<table border="1">
			...
			<tr>
				<td colspan="2" align="center"><input type="button" value="회원가입" onClick="inputCheck()" />&nbsp;&nbsp; <input type="reset" value="다시입력" />
				&nbsp;&nbsp; <input type="button" value="나가기" onClick="javascript:window.location='login.jsp'" /></td>
			</tr>
		</table>
	</form>
